...
2. **Negocio** — una consulta preparada comprueba que el identificador existe y está activo (`activa = 1`). Una ciudad desactivada deja de aparecer en el selector *y* su URL antigua deja de funcionar.
